...
<head>
	...
	<link rel="stylesheet" href="/resource/css/creat_project.css">
	<link rel="stylesheet" href="/resource/css/DateTimePicker.css">
</head>
<body>
		...
		<div class="row">
			<div class="col-xs-offset-1 col-xs-10 col-md-offset-4 col-md-4">
				...
				<form action="" method="" role="form" id="form-team">
					...
					<div class="row">
						<div class="col-xs-12">
							<input type="text" data-field="datetime" class="form-control form-register iconfont" name="password" id="dateinput" placeholder="&#xe611;&nbsp;启动时间" required="true">
							<div id="dtBox" class="dtpicker-overlay dtpicker-mobile"><div class="dtpicker-bg"><div class="dtpicker-cont"><div class="dtpicker-content"><div class="dtpicker-subcontent"></div></div></div></div></div>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-7 register"><button type="submit" class="btn btn-register">创&nbsp;建</button></div>
					</div>
				</form>
