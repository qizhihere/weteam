...
<head>
	...
	<link rel="stylesheet" href="/resource/css/find_member.css">
</head>
<body>
	...
	<div class="container">
		...
		<div class="row row-confirm">
			...
			<div class="col-xs-offset-3 col-xs-5 confirm">
				<button class="btn-search" type="submit"><i class="iconfont icon-confirm">&#xe648;</i><span class="icon-confirm">确认添加</span></button>
			</div>
		</div>
	</div>
