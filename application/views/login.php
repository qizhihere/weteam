		...
		<div class="row">
			<div class="col-xs-offset-1 col-xs-10 col-md-offset-4 col-md-4">
				...
				<form action="" method="" role="form" id="form-team">
					<div class="row">
						<div class="col-xs-12">
							<input type="email" class="form-control" id="e-mail-team" name="e-mail" placeholder="&nbsp;邮&nbsp;箱" required="true">
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12">
							<input type="password" class="form-control" id="password-team" name="password" placeholder="&nbsp;密&nbsp;码" required="true">
						</div>
					</div>
					<div class="row">
				...
				<form action="" method="" role="form" id="form-individual">
					<div class="row">
						<div class="col-xs-12">
							<input type="email" class="form-control" id="e-mail-individual" name="e-mail" placeholder="&nbsp;邮&nbsp;箱" required="true">
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12">
							<input type="password" class="form-control" id="password-individual" name="password" placeholder="&nbsp;密&nbsp;码" required="true">
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12 btn-logindiv">
				...
				<div class="row">
					<div class="col-xs-4 col-xs-offset-8 register"><a href="">立即注册</a></div>
				</div>
			</div>
		</div>
