...
<head>
	...
	<link rel="stylesheet" href="/resource/css/about_project.css">
</head>
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-md-offset-4 col-md-4">
				...
				<!-- <form action="" method="" role="form" id="form-team">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-7 register"><button type="submit" class="btn btn-register">加入项目</button></div>
					</div>
				</form>
